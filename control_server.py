...
# --- Vision (YOLO tracker debug + live config) ---
...
@app.get("/api/vision/yolo-config")
...
@app.post("/api/vision/yolo-config")
async def vision_yolo_config_set(body: YoloConfigInput):
    # load whatever is on disk, merge in only whitelisted+numeric keys, write back, hot-reload
